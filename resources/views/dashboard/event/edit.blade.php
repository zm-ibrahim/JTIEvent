...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <form method="post" action="{{ route('dashboard.event.update', $event->id) }}" class="needs-validation" novalidate=""
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="end_date" name="end_date" type="date"
                                class="form-control @error('end_date') is-invalid @enderror" value="{{ $event->end_date }}"
                                required="">
                            @error('end_date')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="height: 100px" id="description" name="description"
                                class="form-control @error('description') is-invalid @enderror" required="">{{ $event->description }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
